...
export const WrongBlog = () => {
  return (
    <div>
      <div class="banner">

 
<p className="u-center-text"> <img src="" class="" alt="actionable-tips-to-maximize-your-coffee-shops-profit"/></p>
...
<h1 ><strong>What Almost Every Mobile Business Does Wrong</strong></h1>
...
<div class="row">
 ...
 <div class="col-md-6 col-md-offset-3">
     ...
     <h3 align="center"><strong>SUB-HEADING GOES HERE</strong></h3><br />
         <p><img src="" alt="coffee-shop-marketing" class="" /></p>
     ...
     <h3 align="center"><strong>SUB-HEADING GOES HERE</strong></h3><br />
           <p><img src="" alt="coffee-shop-marketing-company" class="i" /></p>
     ...
     <h3 align="center"><strong>SUB-HEADING GOES HERE</strong></h3><br />
           <p><img src="" alt="maximize-your-coffee-shops-profit" class="" /></p>

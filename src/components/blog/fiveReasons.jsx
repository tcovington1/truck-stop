...
import PhotoOne from '../../assets/blog1.jpg'
import { BlogHeader } from './blogHeader'

export const fiveReasons = () => {
  return (
    <div>
      {/* <BlogHeader title='5 Ways To Grow Your Mobile Business Online'/> */}
      <div className="post-header">

        <div className="post-header__text-box">

          <h1 className='heading-secondary--white ' >5 Ways To Grow Your Mobile Business Online</h1>
        </div>
        {/* <p className="u-center-text"> <img src={PhotoOne} className="banner-img" alt="actionable-tips-to-maximize-your-coffee-shops-profit"/></p> */}
        ...
        <div class="jumbotron blogtext blog-content blog-container">

        <div class="row">
        
        <div class="col-md-6 col-md-offset-3">

            <p className="date"><span class=""></span> Last updated Nov. 1, 2017</p><br />
            ...
            <h3 align="center"><strong>SUB-HEADING GOES HERE</strong></h3><br />
                <p className="u-center-text my2"><img src={PhotoOne} alt="coffee-shop-marketing" className="blog-img" /></p>
            ...
            <h3 align="center"><strong>SUB-HEADING GOES HERE</strong></h3><br />
                  <p className="u-center-text my2"><img src={PhotoOne} alt="coffee-shop-marketing-company" className="blog-img" /></p>
            ...
            <h3 align="center"><strong>SUB-HEADING GOES HERE</strong></h3><br />
                  <p className="u-center-text my2"><img src={PhotoOne} alt="maximize-your-coffee-shops-profit" className="blog-img" /></p>
